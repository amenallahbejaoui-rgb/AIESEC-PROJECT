...
const storage = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, "../Frontend/est-landingpage/public/images");
  },
...
mongoose
  .connect(
    "mongodb+srv://backend-server:DEk0OCBu2phtBUL5@cluster0.pguhwow.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
    {
